    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["external_source", "trans_id"],
                name="unique_document_by_source_trans_id",
            ),
            models.UniqueConstraint(
                fields=["customer", "document_type", "document_number"],
                name="unique_document_by_customer_type_number",
            ),
        ]
        indexes = [
            models.Index(fields=["customer"]),
